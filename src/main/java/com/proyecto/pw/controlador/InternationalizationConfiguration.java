...
/**
 * Clase de configuración para la internacionalización (i18n) en una aplicación
 * Spring Boot. Permite la configuración de la resolución de locales, fuentes de
 * mensajes y cambios de idioma.
 */
@Configuration
